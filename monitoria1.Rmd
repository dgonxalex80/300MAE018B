...
ggplot(df, aes(x, y)) +
  geom_line(linewidth = 1, color = c3) +
  geom_point(size = 2, color = c3) +
...
# Imprimiendo los datos simulados
tiempos
...
<!-- <br/><br/><br/> -->
<!-- <div class="box1 with-label"> <div class="label">Problema 25</div> -->
<!-- </div> -->
