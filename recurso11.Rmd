...
knitr::include_graphics("img/metodologia123.png")
```
...
Son valores numéricos que pueden estar relacionados con la medición, el conteo de eventos o también con niveles numéricos que se asignen a variables que se miden a través de test, pero que corresponden a variables cualitativas. A este último proceso descrito se le llama operacionalización de una variable cualitativa. 
...
```{r, echo=FALSE, out.width="70%", fig.align = "center"}
knitr::include_graphics("img/tiposvariables.png")
```
...
Es importante poder distinguir entre variables estadísticas y variables no estadísticas en una base de datos. Para hacerlo nos preguntamos si para la variable en análisis tiene sentido un análisis estadístico (gráficos, tabla o indicadores). Por ejemplo: no tiene sentido realizar un análisis con variables como: id, nombre, correo electrónico, dirección, teléfono, longitud y latitud, representante legal, entre otras. 
...
```{r, echo=FALSE, out.width="70%", fig.align = "center"}
knitr::include_graphics("img/tiposmuestreo.png")
```
...
En este método se selecciona inicialmente un grupo de entrevistados. El resto de entrevistados se eligen de acuerdo con información suministrada por los mismos entrevistados -referidos-. Este método permite obtener información rápida y muy fácilmente.
